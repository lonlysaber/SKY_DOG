...
object dayPrinviceTop3 {
  def main(args: Array[String]): Unit = {
    ...
    // 设置检查点目录
    ssc.checkpoint("C:\\Users\\86131\\Desktop\\检查点\\dayProvinceTop")
    /*
    配置kafka消费者参数
